...
//     */
//    @Override
//    public MyPage<UserDTO> (String key, int pageNumber, int pageSize, String sortField, String sortOrder) {
//
//        /*排序条件筛选*/
//        switch (sortField){
//            case "id":
...
//        List<User> all = userMapper.getAll(key, sortField, sortOrder);
//        PageInfo<User> userPageInfo = new PageInfo<>(all);
//        List<UserDTO> userDTOS = new LinkedList<>();
//        Iterator<User> iterator = userPageInfo.getList().iterator();
//        while (iterator.hasNext()) {
//            User next = iterator.next();
//            UserDTO userDTO = userToUserDTO(next);
//            //System.out.println("赋值完成的userDTO:" + userDTO.toString());
//            userDTOS.add(userDTO);
//        }
//        MyPage<UserDTO> userDTOMyPage = new MyPage<>(userPageInfo.getTotal(), userDTOS);
//        LOGGER.info("封装完成的自定义page对象:" + userDTOMyPage.toString());
//        return userDTOMyPage;
//    }
